...
export const metadata: Metadata = {
  ...
  icons: {
    icon: "/favicon.svg", // primary modern favicon
    shortcut: "/favicon-32x32.png", // fallback for older browsers
    apple: "/apple-touch-icon.png", // iOS / iPad
  },
...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      ...
      <body className="m-0 p-0 px-20  bg-gradient-to-b from-white to-gray-50 dark:from-gray-950 dark:to-gray-900">
