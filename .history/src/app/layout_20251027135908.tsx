...
const frontendUri = process.env.FRONTEND_URI ?? "https://maphy.vercel.app";
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              name: "Mahesh Nayak",
              url: frontendUri,
              image: frontendUri + "/profile.png",
              sameAs: [
                "https://github.com/Maheshna369",
                "https://www.linkedin.com/in/mahesh-nayak-53b653249",
                "https://x.com/maheshna_369",
              ],
