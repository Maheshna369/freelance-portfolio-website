    ...
    >
      ...
      <div className="w-full flex flex-wrap justify-between items-center px-4">
        {services.map((service, index) => (
          ...
          >
            <CardContainer className="w-full h-full flex justify-center py-4">
              <CardBody className="bg-white h-full dark:bg-gray-800 w-full h-auto p-5 rounded-xl shadow-lg hover:scale-105 transition-transform duration-300">
