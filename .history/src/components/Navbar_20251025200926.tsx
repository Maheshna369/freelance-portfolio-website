  ...
  return (
    <>
      ...
      {showNav && (
        <div
          ref={navRef}
          className="fixed inset-0 z-50 flex justify-end items-center bg-black/40 backdrop-blur-md transition-all duration-300 lg:hidden"
        >
          <Tooltip.Provider delayDuration={150}>
            <motion.nav
              ...
              className="w-4/5 sm:w-1/2 h-full bg-white dark:bg-gray-950 shadow-[0_0_20px_rgba(0,0,0,0.2)] rounded-l-2xl flex flex-col items-center justify-between py-10 px-6 relative"
            >
              {/* Close Button */}
              <button
              ...
              <div className="flex flex-col items-center gap-4 w-full mt-6">
                <button
                  onClick={() => setTheme(theme === "light" ? "dark" : "light")}
                  className="flex items-center gap-2 px-4 py-2 rounded-md text-gray-800 dark:text-gray-200 border border-gray-400 dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-gray-800 transition-all duration-200"
                >
                  {theme === "light" ? <DarkModeIcon /> : <LightModeIcon />}
                ...
                <button
                  ...
                  className="relative inline-flex items-center justify-center h-12 px-6 overflow-hidden rounded-xl text-white font-medium transition-all duration-300 bg-gradient-to-r from-indigo-600 to-blue-600 hover:opacity-90 shadow-lg hover:shadow-indigo-400/40"
                >
