...
const Contact: React.FC = () => {
  ...
  return (
    ...
    >
      {/* Email Section */}
      <div className="w-full bg-gradient-to-r from-white to-gray-50 dark:from-gray-800 dark:to-gray-900 border border-gray-200 dark:border-gray-700 rounded-2xl p-5 shadow-sm hover:shadow-lg transition-all duration-300">
        <a
        ...
        <p className="text-sm text-gray-500 mt-1">Fastest Response (within 6 hours)</p>
      </div>
      ...
      <div>
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          ...
          <a
            ...
            className="flex items-center gap-3 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl p-4 shadow-sm hover:shadow-lg hover:scale-[1.02] transition-all duration-300"
          >
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">Top-rated seller • Quick delivery</p>
            </div>
          </a>
      ...
      <p className="mt-6 text-gray-500 dark:text-gray-400 italic text-sm text-center">
        ⚡ Let’s build something exceptional — I usually respond within 6 hours.
      </p>
    </motion.div>
