...
const Services = () => {
  ...
  return (
    ...
    >
      {/* Heading */}
      <h2 className="w-full text-left lg:text-center text-3xl md:text-4xl font-bold mb-3 lg:mb-4">
        I Build Websites That Actually Grow Your Business
      </h2>

      {/* Subheading */}
      <p className="w-full text-left lg:text-center mb-6 lg:mb-12 text-lg px-4 md:px-20">
      ...
      <div className="w-full flex flex-wrap justify-between items-center ">
        {services.map((service, index) => (
          <div
            key={index}
            className="flex-shrink-0 w-full my-5 sm:w-[45%] lg:w-[500px] lg:h-[500px]"
          >
