...
const Navbar = () => {
  ...
  return (
    <header
      className={`w-full h-20 flex justify-between items-center sticky top-0 z-50 transition-all duration-300
    ${
      scrolled
        ? "bg-white/0 dark:bg-gray-900/0 backdrop-blur-md shadow-md"
        : "bg-transparent"
    }`}
    >
      {/* Branding */}
