    ...
    >
      ...
      <div className="w-full flex flex-wrap justify-between items-center px-4">
        {services.map((service, index) => (
          <div
            key={index}
            className="flex-shrink-0 w-full m-5 sm:w-[45%] lg:w-[500px] lg:h-[500px]"
          >
            <CardContainer className="w-full h-full flex justify-center py-4">
              <CardBody className="bg-white  dark:bg-gray-800 w-full h-full p-5  rounded-xl shadow-2xlhover:scale-105 transition-transform duration-300">
