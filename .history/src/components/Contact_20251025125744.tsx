...
const Contact: React.FC = () => {
  ...
  return (
    ...
    Work With Me — Let’s Build Your Digital Solution
  </h3>
  <p className="text-gray-600 dark:text-gray-400">
    Fast, reliable, and results-driven solutions for your business.
  </p> */}

          {/* Email Section */}
          <div className="bg-white dark:bg-gray-800 border rounded-xl p-4 shadow-sm hover:shadow-md transition">
            <a
              href="mailto:maheshnayak9639@gmail.com"
              className="flex items-center gap-3 text-gray-900 dark:text-gray-100 font-medium"
            >
              <Mail className="w-5 h-5" />
              Email Me Directly
            </a>
            <p className="text-sm text-gray-500 mt-1">Fastest Response</p>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              ...
              <a
                href="#"
                target="_blank"
                className="flex items-center gap-3 bg-white dark:bg-gray-800 border rounded-xl p-3 hover:shadow-md transition"
              >
                <img
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">
                    Top-rated freelancer, 5-star rating
                  </p>
                </div>
              </a>
              ...
              >
                <img
                  src="https://upload.wikimedia.org/wikipedia/commons/7/7d/Toptal-logo.png"
                  alt="Toptal"
                  className="w-5 h-5"
                />
                <div>
              ...
              >
                <img
                  src="https://cdn.freelancer.com/mobile/favicon.ico"
                  alt="Freelancer"
                  className="w-5 h-5"
                />
                <div>
                  ...
                  <p className="text-sm text-gray-500">
                    Affordable & beginner-friendly platform
                  </p>
                </div>
              </a>
              ...
              >
                <img
                  src="https://assets-global.website-files.com/60d3b3b6a5c0a04a3ce1711b/6148e2cf6d0f7b56a9c998d2_contra%20favicon.png"
                  alt="Contra"
                  className="w-5 h-5"
                />
                <div>
                  ...
                  <p className="text-sm text-gray-500">
                    No fees, modern freelancer platform
                  </p>
                </div>
              </a>
              ...
              >
                <img
                  src="https://www.guru.com/favicon.ico"
                  alt="Guru"
                  className="w-5 h-5"
                />
                <div>
              ...
              >
                <img
                  src="https://www.peopleperhour.com/favicon.ico"
                  alt="PeoplePerHour"
                  className="w-5 h-5"
                />
                <div>
