...
const HeroSection = () => {
  return (
    <section className="relative flex flex-col-reverse lg:flex-row items-center justify-between py-16 lg:py-28 overflow-hidden">
      {/* Left Content */}
      ...
      >
        ...
        <div className="relative w-80 h-80 sm:w-96 sm:h-96 lg:w-[28rem] lg:h-[28rem] rounded-full overflow-hidden shadow-xl shadow-blue-500/20">
          <Image
            src="/profile.png"
            alt="Mahesh Nayak"
            fill
