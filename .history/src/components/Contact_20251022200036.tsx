    ...
    <section className="w-full flex flex-col justify-center items-center py-20 px-4 lg:px-20 bg-gray-50 dark:bg-gray-900">
      ...
      >
        ...
        <p className="text-lg lg:text-xl text-gray-600 dark:text-gray-300">
          Have a project, idea, or question? Reach out and let's craft
          high-performance web apps and digital solutions that deliver real
          impact.
        </p>
      </motion.div>
        ...
        >
          ...
          <LabelInputContainer>
            ...
            <select
              ...
              onChange={handleChange}
              className="border rounded-md p-2 text-gray-900 dark:text-gray-100 bg-white dark:bg-gray-800"
            >
