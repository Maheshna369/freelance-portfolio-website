  ...
  return (
    ...
    >
      ...
      <div className="w-full flex flex-col justify-center items-center text-left lg:text-left">
        ...
        <p className="text-lg lg:text-lg text-gray-600 dark:text-gray-300 mb-1 lg:mb-5">
      ...
      {/* TWO-COLUMN LAYOUT */}
      <div className="w-full flex flex-col-reverse lg:flex-row justify-center items-center gap-6 lg:gap-0 lg:justify-between lg:items-center mt-3 lg:mt-0">
        ...
        <div className="lg:w-1/2 flex flex-col gap-6">
          ...
          <div className="grid grid-cols-3 gap-5 lg:hidden justify-items-center">
            {skills[activeCategory].map((skill, idx) => (
              <motion.div
                key={idx}
              ...
              >
                <div className="relative w-16 h-16 rounded-full flex items-center justify-center border-2 border-gray-600 dark:border-gray-700">
                  {/* Progress Circle */}
                  <svg className="absolute w-16 h-16 transform -rotate-90">
                    ...
                    <motion.circle
                      ...
                      whileInView={{
                        strokeDashoffset: 176 - (176 * skill.level) / 100,
                      }}
                  ...
                  {skill.icon ? (
                    <skill.icon
                      className={`w-7 h-7 ${theme === "dark" ? "fill-white" : "fill-black"} relative z-10`}
                    />
                  ) : null}
                </div>
                <p className="text-xs mt-2 text-gray-400">{skill.level}%</p>
              </motion.div>
            ))}
          </div>
        </div>
