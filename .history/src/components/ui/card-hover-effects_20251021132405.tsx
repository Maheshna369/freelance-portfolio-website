...
export const HoverEffect = ({
  ...
  items: {
    ...
    liveDemo?: string;
    github?: string;
    skills?: React.FC<React.SVGProps<SVGSVGElement>>[]; // React SVG Components
  }[];
  className?: string;
}) => {
...
export const Card = ({
  ...
  return (
    <div
      className={cn(
        "flex flex-col rounded-2xl h-full w-full overflow-hidden bg-black border border-transparent dark:border-white/[0.2] group-hover:border-slate-700 relative z-20",
        className
      )}
    >
