...
export const Card = ({
  ...
  return (
    <div
      className={cn(
        "flex flex-col rounded-2xl h-full w-full overflow-hidden border border-transparent dark:border-white/[0.2] group-hover:border-slate-700 relative z-20 shadow-3xl hover:shadow-2xl transition-shadow duration-300",
        className
      )}
    >
