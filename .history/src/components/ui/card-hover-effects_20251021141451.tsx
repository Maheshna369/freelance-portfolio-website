      ...
      {items.map((item, idx) => (
            ...
            <div className="flex justify-between items-center gap-3 px-4 pb-4 mt-auto">
              {item.liveDemo && (
                <Link href={item.liveDemo} target="_blank">
                  <button
                    className="
          relative flex-1 py-2 rounded-2xl overflow-hidden text-white font-semibold
        ...
        "
                  >
                    ...
                    <span
                      className="
            absolute inset-0 border-2 border-white opacity-50 rounded
            animate-borderSlide
            pointer-events-none
          "
                    />
              ...
              {item.github && (
                <Link href={item.github} target="_blank">
                  <button
                    className="
          relative flex-1 p-2 rounded-2xl border-2 border-white text-white font-semibold
          overflow-hidden
        ...
        "
                  >
                    <span
                      className="
            absolute inset-0 border-2 border-black opacity-30 rounded
            animate-borderSlide
            pointer-events-none
          "
                    />
