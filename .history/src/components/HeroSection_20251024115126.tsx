...
const HeroSection = () => {
  return (
    <section className="relative flex flex-col justify-center items-center lg:flex-row lg:items-center lg:justify-between py-8 overflow-hidden ">
      {/* Left Content */}
      ...
      >
        <div className="relative w-80 h-80 sm:w-96 sm:h-96 lg:w-[28rem] lg:h-[28rem] rounded-full overflow-hidden shadow-2xl lg:shadow-blue-500/20 transition-transform duration-500 hover:scale-105 hover:rotate-1">
          <Image
            src="/profile.png"
            alt="Mahesh Nayak"
            fill
