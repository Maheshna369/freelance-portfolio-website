...
const SkillsExperience: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      {/* TWO-COLUMN LAYOUT */}
      <div className="w-full flex flex-col-reverse lg:flex-row justify-center items-center lg:justify-between lg:items-center">
        ...
        <div className="lg:w-1/2 flex flex-col gap-6">
          {/* Category Buttons */}
          <div className="flex flex-wrap gap-4 mt-3 lg:mt-0 mb-6">
            {categories.map((cat) => (
              <button
                key={cat}
