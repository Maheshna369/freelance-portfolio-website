...
const HeroSection = () => {
  return (
    <section className="relative flex flex-col-reverse lg:flex-row items-center justify-between py-20 overflow-hidden bg-gray-50 dark:bg-gray-900">
      {/* Left Content */}
      <div className="flex-1 flex flex-col items-center lg:items-start text-center lg:text-left space-y-6 max-w-2xl z-10">
        ...
        >
          ...
          , a results-driven developer creating lightning-fast, SEO-ready
          websites with{" "}
          <span className="font-medium">
            Next.js, React, and the MERN stack
          </span>
          . My goal: convert visitors into paying clients.
        </motion.p>
        ...
        >
          <Link
            href="#contact"
            className="px-10 py-4 rounded-full bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold hover:scale-105 hover:shadow-xl transition-transform duration-300 shadow-blue-500/30"
          >
            Start Your Project →
          </Link>
          <Link
