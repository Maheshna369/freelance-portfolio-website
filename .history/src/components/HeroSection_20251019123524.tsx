...
const HeroSection = () => {
  return (
    <section className="relative flex flex-col-reverse lg:flex-row items-center justify-between py-10 overflow-hidden ">
      {/* Left Content */}
      ...
      >
        <div className="relative w-80 h-[28rem] sm:w-96 sm:h-[32rem] lg:w-[30rem] lg:h-[36rem] overflow-hidden  shadow-[0_20px_60px_-10px_rgba(0,0,0,0.3)]">
          <Image
