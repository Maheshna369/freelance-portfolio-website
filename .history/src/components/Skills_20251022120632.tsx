  ...
  return (
    ...
    >
      ...
      <div className="lg:w-1/2 relative">
        ...
        <div className="absolute left-5 top-0 w-1 bg-gray-300 dark:bg-gray-700 h-full rounded"></div>
        <div className="ml-14 flex flex-col gap-14">
          {experience.map((exp, idx) => (
            ...
            >
              <span className="absolute -left-7 top-1/2 transform -translate-y-1/2 w-5 h-5 bg-gradient-to-tr from-blue-500 to-purple-500 rounded-full shadow-lg border-2 border-white dark:border-gray-900 transition-transform group-hover:scale-125"></span>
