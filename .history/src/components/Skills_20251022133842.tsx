...
const SkillsExperience: React.FC = () => {
  ...
  return (
    <section className="w-full flex flex-col pt-20 pb-8 ">
      {/* Title & Description */}
      <div className="w-full flex flex-col justify-center items-center text-center lg:text-left">
        <h2 className=" w-full text-4xl lg:text-5xl font-extrabold text-gray-900 dark:text-gray-100 mb-4">
          🚀 Experience & Skills That Drive Impact
        </h2>
        <p className="text-lg lg:text-xl text-gray-600 dark:text-gray-300 w-full mb-5">
