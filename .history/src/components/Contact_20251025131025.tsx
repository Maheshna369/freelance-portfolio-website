...
const Contact: React.FC = () => {
  ...
  <p className="text-gray-600 dark:text-gray-400">
    Fast, reliable, and results-driven solutions for your business.
          ...
          {/* Email Section */}
          <div className="w-3/4 bg-white dark:bg-gray-800 border rounded-xl p-4 shadow-sm hover:shadow-md transition">
            <a
          ...
          <div>
            ...
            <div className="w-full flex flex-wrap gap-3">
              ...
              <a
                href="#"
                target="_blank"
                className="w-1/2 flex items-center gap-3 bg-white dark:bg-gray-800 border rounded-xl p-3 hover:shadow-md transition"
              >
