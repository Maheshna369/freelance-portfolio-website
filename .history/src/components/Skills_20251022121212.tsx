...
const SkillsExperience: React.FC = () => {
  ...
  const experience = [
    {
      ...
      description:
        "Built scalable web apps with Next.js, Node.js, and MongoDB. Improved app load speed by 40% and boosted user engagement.",
    },
    {
      year: "2024",
      ...
      description:
        "Delivered 10+ high-quality responsive websites using React & TailwindCSS. Focused on pixel-perfect UI and seamless UX.",
    },
    {
      year: "2023",
      title: "Intern",
      ...
      description:
        "Learned MERN stack, optimized UI/UX, and automated tasks with Node.js scripts, delivering projects faster than expected.",
    },
  ];
  ...
  return (
    <section
      ...
      className="w-full flex flex-col lg:flex-row gap-16 py-20 px-4"
    >
      {/* LEFT: Experience Timeline */}
      <div className="lg:w-1/2 flex flex-col relative">
        <h2 className="text-3xl font-bold text-gray-900 dark:text-gray-100 mb-3">
          🚀 My Journey: From Intern to Full-Stack Powerhouse
        </h2>
        <p className="text-gray-600 dark:text-gray-300 mb-10">
          Explore how I leveled up through real projects, freelance gigs, and
          internships. Every step showcases measurable results and cutting-edge
          tech mastery.
        </p>
      ...
      <div className="lg:w-1/2 flex flex-col gap-8">
        <h2 className="text-3xl font-bold text-gray-900 dark:text-gray-100 mb-3">
          🛠 Skills That Build High-Impact Products
        </h2>
        <p className="text-gray-600 dark:text-gray-300 mb-8">
          These are the tools and technologies I wield to craft seamless, fast,
          and modern web applications that deliver results.
        </p>
