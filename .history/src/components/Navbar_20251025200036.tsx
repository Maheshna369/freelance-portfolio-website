  ...
  return (
    <>
      ...
      {showNav && (
        <div
          ref={navRef}
          className="fixed inset-0 z-50 flex lg:hidden justify-end items-center bg-black/40 backdrop-blur-sm transition-all duration-300"
        >
          <Tooltip.Provider delayDuration={200}>
            <motion.nav
              ...
              className="w-4/5 sm:w-1/2 h-full flex flex-col justify-center items-center gap-6 bg-white dark:bg-gray-900 shadow-2xl rounded-l-2xl p-6"
            >
              {/* Main Nav Links */}
              {[
                ...
                <NavItem
                  ...
                  active={active}
                  onClick={() => setShowNav(false)} // auto-close after click
                />
              ))}
              ...
              {/* <div className="flex flex-col w-full gap-3 mt-4">
                <a
                  href="https://www.fiverr.com/mahesh_nayak"
                  target="_blank"
                  className="w-full text-center py-2 rounded-lg bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-semibold hover:scale-105 transition-transform"
                >
                  Hire Me on Fiverr 🚀
                </a>
                <a
                  ...
                  target="_blank"
                  className="w-full text-center py-2 rounded-lg border border-blue-500 text-blue-600 dark:text-blue-400 font-semibold hover:bg-blue-600 hover:text-white transition-all"
                >
                  Hire via Upwork 🔒
                </a>
              </div> */}
              ...
              <button
                ...
                name="Change theme"
                aria-label="Change theme"
                className="mt-4 px-4 py-2 rounded-md text-gray-800 dark:text-gray-200 border border-gray-400 dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-800 transition"
              >
                {theme === "light" ? <DarkModeIcon /> : <LightModeIcon />}
              </button>
            </motion.nav>
