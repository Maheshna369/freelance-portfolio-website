...
const Navbar = () => {
  ...
  return (
    <header className="w-full h-20 flex justify-between items-center bg-white dark:bg-gray-900/80 text-gray-900 dark:text-white sticky top-0 z-50 backdrop-blur-md">
      {/* Branding */}
