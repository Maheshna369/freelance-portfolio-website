...
const Navbar = () => {
  ...
  return (
    <header className="w-full h-20 flex justify-between items-center bg-gradient-to-b from-white to-gray-50 dark:from-gray-950 dark:to-gray-900 text-gray-900 dark:text-white sticky top-0 z-50 ">
      {/* Branding */}
