...
const Contact: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // TODO: Integrate real API/email sending
        ...
        >
          ...
          <LabelInputContainer>
            ...
            <select
              ...
              onChange={handleChange}
              className="border rounded-md p-2 focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 transition"
            >
          ...
          <LabelInputContainer>
            ...
            <textarea
              ...
              onChange={handleChange}
              rows={5}
              className="resize-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 transition rounded-md border"
            />
            {errors.message && (
