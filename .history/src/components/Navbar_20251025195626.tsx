  ...
  return (
    <>
      ...
      {showNav && (
        <div
          ref={navRef}
          className="w-full h-full fixed right-0 inset-0 flex justify-end items-center"
        >
          <Tooltip.Provider delayDuration={200}>
            <nav className=" w-1/2 h-1/2 flex flex-col justify-center items-center lg:hidden bg-white dark:bg-gray-900">
              <NavItem
                href="/#home"
                label="Home"
                tooltip="Go to homepage"
