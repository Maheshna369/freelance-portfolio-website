  ...
  const experience = [
    {
      ...
      description:
        "Built scalable, high-performance web apps using Next.js, Node.js, and MongoDB. Delivered production-ready projects including e-commerce stores, blogs, and chat apps, with a focus on clean UI/UX, responsive design, and SEO optimization.",
    },
    {
      year: "2024",
