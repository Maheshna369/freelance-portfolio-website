...
const Footer = () => {
  return (
    <footer className="w-full  text-neutral-600 dark:text-neutral-400 pt-14 pb-8 border-t border-neutral-200 dark:border-neutral-800">
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 px-6 sm:px-10">
        ...
        <div>
          ...
          <p className="text-sm leading-relaxed max-w-xs">
            ...
            — a MERN + Next.js Developer & UI/UX Designer. I build
            high-performance, conversion-driven digital experiences that turn
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-4 text-2xl mb-6">
            {[
              ...
              {
                icon: <FaInstagram />,
                href: "https://instagram.com/maheshnayak",
              ...
              },
              {
                ...
                color: "hover:text-neutral-800 dark:hover:text-neutral-300",
              },
            ].map((social, idx) => (
              <a
                key={idx}
