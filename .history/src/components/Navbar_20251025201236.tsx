        ...
        >
          <Tooltip.Provider delayDuration={150}>
            <motion.nav
              ...
              className="w-[70%] sm:w-1/2 h-full bg-white dark:bg-gray-950 shadow-[0_0_20px_rgba(0,0,0,0.2)] rounded-l-2xl flex flex-col items-center justify-between py-10 px-6 relative"
            >
              {/* Close Button */}
              <button
