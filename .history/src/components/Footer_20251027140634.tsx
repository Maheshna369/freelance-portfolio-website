...
const Footer = () => {
  return (
    <footer className="w-full bg-transparent text-neutral-600 dark:text-neutral-400 pt-12 pb-6">
      <div className="w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-16">
        {/* About Me */}
        <div>
          ...
          <p className="text-sm leading-relaxed">
            I’m Mahesh Nayak — a MERN + Next.js Developer who builds fast,
            flawless, and revenue-driven web experiences that turn ideas into
            impact.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm">
            ...
            <li className="flex items-center gap-2 hover:text-indigo-600 dark:hover:text-indigo-400 transition">
              <FaArrowRight />
              <a
                href="https://www.google.com/maps/place/Chatrapur,+Ganjam,+Odisha,+India"
                target="_blank"
                rel="noopener noreferrer"
              >
