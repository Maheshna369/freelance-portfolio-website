...
const Navbar = () => {
  ...
  return (
    <>
      ...
      {showNav && (
        <div className="fixed inset-0 z-50 flex justify-end items-center bg-black/40 backdrop-blur-sm transition-all duration-300 lg:hidden">
          <Tooltip.Provider delayDuration={150}>
            <motion.nav
              ...
              transition={{ type: "spring", stiffness: 60, damping: 0 }}
              className={`w-[65%] sm:w-1/2 h-full shadow-2xl rounded-l-2xl flex flex-col items-center justify-between py-10 px-6 relative border-l ${
                theme === "light"
