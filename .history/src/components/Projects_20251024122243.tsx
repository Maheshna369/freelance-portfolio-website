...
const Projects = () => {
  ...
  return (
    <section
      ...
      id="projects"
    >
      <h2 className="text-3xl md:text-4xl font-bold text-left lg:text-center mb-4">
        I Don’t Just Build Websites — I Build Proof.
      </h2>
      <p className="text-left lg:text-center mb-2 lg:mb-5 text-lg text-gray-600 dark:text-gray-300">
