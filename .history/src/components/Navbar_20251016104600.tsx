...
const Navbar = () => {
  return (
    <header className="w-full h-20 flex justify-between items-center px-8 bg-white/70 backdrop-blur-md sticky top-0 z-50 shadow-sm">
      {/* Branding */}
    ...
    <Tooltip.Root>
      ...
      <Tooltip.Portal>
        <Tooltip.Content
          ...
          align="center"
          sideOffset={6}
          className="bg-black text-white text-sm px-3 py-1 rounded-md shadow-md animate-fadeIn z-10"
        >
          {tooltip}
