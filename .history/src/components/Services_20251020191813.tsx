        ...
        {services.map((service, index) => (
          <div key={index} className="flex flex-col items-center">
            <CardContainer className="flex justify-center">
              <CardBody className="bg-white dark:bg-gray-800 w-auto p-4 rounded-xl shadow-lg hover:scale-105 transition-transform duration-300">
                ...
                {/* Buttons inside card */}
                <CardItem className="flex gap-3 mt-2">
                  <Link href="#contact">
