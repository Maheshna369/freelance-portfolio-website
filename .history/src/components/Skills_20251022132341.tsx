...
const SkillsExperience: React.FC = () => {
  ...
  const experience = [
    {
      ...
      description:
        "Built scalable, high-performance web apps using Next.js, Node.js, and MongoDB. Delivered production-ready projects including e-commerce stores, blogs, and chat apps, focusing on clean UI/UX, SEO, and responsive design.",
    },
    {
      year: "2024",
      ...
      description:
        "Delivered polished, responsive websites using React & TailwindCSS. Specialized in fast-loading pages, intuitive interfaces, and user-first design to maximize engagement and conversion.",
    },
    {
      year: "2023",
      ...
      company: "CCTC",
      description:
        "Completed an advanced robotics course, mastering electronics, automation, and programming. Developed critical problem-solving skills that strengthen software architecture and logical thinking.",
    },
  ];
  ...
  return (
    <section
      ...
      className="w-full flex flex-col justify-center items-stretch gap-12 pt-20 pb-8"
    >
  ...
  {Object.entries(skills).map(([category, skillArr], idx) => (
    <div key={idx} className="flex flex-col gap-4">
      <h3 className="text-2xl font-bold text-gray-900 dark:text-gray-100">{category}</h3>
