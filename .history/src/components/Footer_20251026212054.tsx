...
import { ReactComponent as FiverrLogo } from "@/assets/platforms/fiverr.svg";
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 px-6">
        ...
        <div>
          ...
          <p className="text-sm leading-relaxed">
            ...
            build sleek, high-performance, and conversion-focused digital
            experiences that help brands grow fast and look premium.
          </p>
        </div>
