...
const Contact: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
          ...
          success: () => {
            ...
            return (
              <div className="flex flex-col items-start gap-2">
                ...
                <p className="text-gray-600 dark:text-gray-300 text-sm leading-tight">
                  Thanks <span className="font-semibold">{payload.name}</span> —
                  I’ll reply within a few hours.
                </p>

                {/* ✅ High CTR CTA */}
                <button
                  onClick={() => openPrimaryInbox(payload.email)}
                  className="mt-1 inline-flex items-center gap-2 bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 text-white px-3 py-1.5 rounded-lg text-xs font-medium transition-all duration-200 active:scale-95"
                >
      ...
      if (response.status === 200 && response.data.success)
        console.log("Message successfully delivered to backend ✅");
    } catch (error: unknown) {
  ...
  const openPrimaryInbox = (email: string) => {
    let providerUrl = "https://mail.google.com"; // default Gmail
    const domain = email.split("@")[1]?.toLowerCase() || "";

    if (domain.includes("yahoo")) providerUrl = "https://mail.yahoo.com";
      ...
      <div className="w-full flex flex-col lg:flex-row gap-6 lg:gap-12">
        ...
        >
          ...
          <div className="w-full relative bg-gradient-to-r from-white to-gray-50 dark:from-gray-800 dark:to-gray-900 border border-gray-200 dark:border-gray-700 rounded-2xl p-5 shadow-sm hover:shadow-lg transition-all duration-300">
            ...
            <Tooltip title={copyEmail ? "Copied!" : "Copy Email"}>
              <span
                onClick={handleCopy}
                className={`absolute top-0 right-0 m-3 cursor-pointer flex items-center justify-center w-8 h-8 rounded-full transition-all duration-300
            ${
              copyEmail
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">
                    Fast, clean, custom web apps. Built for results.
                  </p>
                </div>
              </a>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">
                    Reliable full-stack dev. Clear code, clear communication.
                  </p>
                </div>
              </a>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">
                    Aiming for elite-level projects. Precision work only.
                  </p>
                </div>
              </a>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">
                    Affordable builds for startups. Scalable and sharp.
                  </p>
                </div>
              </a>
