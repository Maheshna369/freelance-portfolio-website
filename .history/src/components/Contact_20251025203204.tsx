    ...
    >
      ...
      <div className="w-full flex flex-col lg:flex-row gap-6 lg:gap-12">
        ...
        >
          ...
          <p className="mt-3 lg:mt-6 text-gray-500 dark:text-gray-400 italic text-sm text-center">
            Let’s build something exceptional — I usually respond within 6
            hours.
          </p>
        </motion.div>
        <span className="w-full lg:w-5 lg:h-96 flex lg:inline-block justify-center items-center text-gray-900 dark:text-white">
          OR,
        </span>
        {/* RIGHT FORM */}
        <motion.form
