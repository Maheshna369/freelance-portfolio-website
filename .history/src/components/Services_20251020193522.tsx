  ...
  return (
    ...
    >
      ...
      <div className="w-full ">
        <div className="flex flex-row gap-6 min-w-max px-4">
            ...
            <div key={index} className="w-80  flex-shrink-0">
              <CardContainer className="w-full flex justify-center py-4">
                <CardBody className="bg-white dark:bg-gray-800 w-full h-auto p-4 rounded-xl shadow-lg hover:scale-105 transition-transform duration-300">
                  ...
                  <CardItem className="w-full flex justify-between items-center mt-2 gap-2">
                    <Link href="#contact">
                      <button className="flex-1 text-white py-2 rounded transition-colors bg-blue-600 hover:bg-blue-700">
                        Let’s Talk
                      </button>
                    </Link>
                    <Link href="#contact">
                      <Button className="flex-1 py-2 rounded hover:bg-green-600 transition-colors text-xl">
                        Buy Now
                      </Button>
                    </Link>
                  </CardItem>
